...
class ModelManager:
    ...
    def train(self):
        clear_data_dir("{0}/data_dir/".format(self.data_dir))
    ...
    def _data_preparation(self):
        data_preparator = DataPreparator(self.data_dir, self.allowed_category)
        data_preparator.build()
        write_config(self.model_name, self.data_dir, data_preparator.get_category_count())
    ...
    def _create_train_script(self):
        ...
        pipeline_config = "--pipeline_config_path={0}/data_dir/tf_api.config".format(self.data_dir)
        train_dir = "--train_dir={0}/data_dir/checkpoints".format(self.data_dir)
